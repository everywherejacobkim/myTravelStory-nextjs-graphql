...
const StoryCard = ({ story, traveler }) => {
    return (
        <div className='bg-white shadow-lg rounded-2xl p-0 lg:p-0 pb-10 mb-8'>
            ...
            <div className='flex justify-end items-end mt-4'>
                ...
                <p className='text-[12px] mr-1 mb-[0.1em]'>{traveler.name}</p>
                <img src={traveler.photo} alt={traveler.name} height='40px' width='40px' className='rounded-full' />
            </div>
            </div>
